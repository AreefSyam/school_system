...
<body>
    ...
    <nav class="navbar navbar-light bg-light static-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a class="btn btn-success btn-sm" href="{{ route('login') }}">Sign In</a>
        </div>
    </nav>

    <!-- Masthead -->
    <header class="masthead"
        style="background: url('{{ asset('assets/images/wisma.png')}}') no-repeat center center; background-size: cover; height: 50vh">
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="text-center text-white">
                        <h1 class="mb-5" style="font-weight: bold; font-family: 'Poppins', sans-serif;">
                            Welcome to KAFA As-Saadah's Examination Analytics Portal </h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-6 order-lg-2 text-white showcase-img"
                    style="background-image: url('assets/images/bg-showcase-1.jpg')"></div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 text-white showcase-img"
                    style="background-image: url('assets/images/bg-showcase-2.jpg')"></div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 order-lg-2 text-white showcase-img"
                    style="background-image: url('assets/images/bg-showcase-3.jpg')"></div>
                <div class="col-lg-6 order-lg-1 my-auto showcase-text">
    ...
    <!-- Call to Action-->
    <section class="call-to-action text-white text-center" id="signin">
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    ...
                    <form class="form-subscribe" id="contactFormFooter" data-sb-form-api-token="API_TOKEN">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto"><button class="btn btn-success btn-lg disabled" id="submitButton"
            ...
            <div class="row">
                <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                    <ul class="list-inline mb-2">
                        <li class="list-inline-item"><a href="#!" class="green-link">About</a></li>
                        <li class="list-inline-item">⋅</li>
                        <li class="list-inline-item"><a href="#!" class="green-link">Contact</a></li>
                        <li class="list-inline-item">⋅</li>
                        <li class="list-inline-item"><a href="#!" class="green-link">Terms of Use</a></li>
                        <li class="list-inline-item">⋅</li>
                        <li class="list-inline-item"><a href="#!" class="green-link">Privacy Policy</a></li>
                    </ul>
                    <p class="text-muted small mb-4 mb-lg-0">&copy; IPerform Kafa As-Saadah 2024. All Rights Reserved.</p>
                </div>
                    ...
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item me-4">
                            <a href="https://www.facebook.com/kafaassaadahjengka/?locale=ms_MY" target="_blank"
                                rel="noopener noreferrer" class="green-link d-flex align-items-center">
                                <i class="bi-facebook fs-3 me-2"></i>
                                <span>Kafa Pengajian As-Saadah</span>
                            </a>
                        </li>
                    </ul>
                </div>
