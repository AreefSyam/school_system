...
{{-- <div class="col-lg-6 text-center text-lg-end my-auto">
    <ul class="list-inline mb-0">
        <li class="list-inline-item">
            <a href="https://www.facebook.com/kafaassaadahjengka/?locale=ms_MY" target="_blank"
                rel="noopener noreferrer" class="text-light text-decoration-none d-flex align-items-center">
                <i class="bi-facebook fs-3 me-2 text-light"></i>
                <span class="d-none d-lg-inline">Kafa Kelas Pengajian Islam As-Saadah</span>
            </a>
        </li>
    </ul>
</div> --}}
...
{{-- <div class="col-lg-6 h-100 text-center text-lg-end my-auto">
    <ul class="list-inline mb-0">
        <li class="list-inline-item me-4">
            <a href="https://www.facebook.com/kafaassaadahjengka/?locale=ms_MY" target="_blank"
                rel="noopener noreferrer" class="white-link d-flex align-items-center">
                <i class="bi-facebook fs-3 me-2 text-white"></i>
                <span>Kafa Kelas Pengajian Islam As-Saadah</span>
            </a>
        </li>
    </ul>
</div> --}}
...
{{--
<!-- Footer-->
<footer class="footer bg-success text-white text-center bg-success">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                ...
                <p class="text-muted small mb-4 mb-lg-0">&copy; KajiLah - Kafa Kelas Pengajian Islam As-Saadah 2024.
                    All Rights Reserved.
                </p>
            </div>
                ...
                <ul class="list-inline mb-0">
                    <li class="list-inline-item me-4">
                        <a href="https://www.facebook.com/kafaassaadahjengka/?locale=ms_MY" target="_blank"
                            ...
                            <i class="bi-facebook fs-3 me-2 text-success"></i>
                            <span>Kafa Kelas Pengajian Islam As-Saadah</span>
                        </a>
                    </li>
                </ul>
